...
if __name__ == '__main__':
    main()
    """ 
    Scaling increases the performance: The model validation accuracy is: 96.10% (beta:0.85, lr:0.35-0.05)
    Tuning the parameters (beta:0.9, lr:0.15-0.05) The model validation accuracy is: 96.98%
    """
