...
if __name__ == '__main__':
    main()
    """ 
    Increasing the network complexity (+1 hidden layer, 178 nodes) we obtain a validation accuracy of 97.63%
    Tuning momentum (beta = 0.76) the model validation accuracy is: 98.27%
    """
